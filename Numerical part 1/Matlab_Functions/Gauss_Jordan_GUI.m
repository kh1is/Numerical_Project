...
% Last Modified by GUIDE v2.5 11-May-2018 21:23:14
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
data =  get(handles.aug_table,'Data')
answer = Solve_Gauss_jordan(data);
allOneString = sprintf('%.6f, ' , answer);
allOneString = allOneString(1:end-1);
set(handles.answer_text, 'String', allOneString);
...
n = str2num(get(handles.aug_dimen_n, 'String'));
m = str2num(get(handles.aug_dimen_m, 'String'));
handles.aug_table.Data = zeros(n, m);
handles.aug_table.ColumnEditable = true;
